...
function TypeRoom() {
  ...
  const data = [
    {
      name: "Homestay",
      des: "Căn hộ dịch vụ đặc biệt với quang cảnh hoang dã",
      img: "https://i.imgur.com/3qJYpe5.jpg",
    },
    {
      name: "Hotel",
      des: "Nghỉ dưỡng với khách sạn cao cấp",
      img: "https://i.imgur.com/zRolu7P.jpg",
    },
    {
      name: "Hotel",
      des: "Nghỉ dưỡng với khách sạn cao cấp",
